...
( function() {
	CKEDITOR.plugins.add( 'datadrop', {
		...
		afterInit: function( editor ) {
            ...
            var placeholderReplaceRegex2 = /\[\[([^\[\]])+\]\]/g;
			...
			editor.dataProcessor.dataFilter.addRules( {
				text: function( text, node ) {
                    ...
                    text = text.replace( placeholderReplaceRegex, createWidget);
                    return text.replace( placeholderReplaceRegex2, createWidget);
				}
			} );
		}
    } );
    
    const createWidget = (match) => {
